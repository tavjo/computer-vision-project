...
if __name__ == "__main__":
    ...
    test_data_url = "http://images.cocodataset.org/zips/test2017.zip"
    ...
    test_zip_path = os.path.join(base_path, "test2017.zip")
    # extract paths
    ...
    test_dataset_extract_path = os.path.join(base_path, "coco_test2017/test2017")
    ...
    download_coco_dataset(test_data_url, test_zip_path)
    ...
    extract_coco_dataset(test_zip_path, test_dataset_extract_path)
